...
EVAL_QUERIES = [
    {"query": "machine stopped unexpectedly during operation",
     "relevant_docs": ["production_line_downtime_response_playbook.md"]},
    {"query": "software issue reported by operators on the line",
     "relevant_docs": ["incident_reporting_workflow.md"]},
    {"query": "power usage seems higher than normal",
     "relevant_docs": ["consumption_monitoring.md"]},
    {"query": "maintenance keeps happening on the same equipment",
     "relevant_docs": ["root_cause_analysis_framework.md"]},
    {"query": "who decides when production jobs get delayed",
